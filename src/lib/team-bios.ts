...
export const teamBios: TeamBio[] = [
  ...
  },
  {
    slug: "ana-liu",
    name: "Ana Liu",
    role: "Guitar, Music Production",
    portraitSrc: "/images/team/bios/ana-liu.webp",
    bioParagraphs: [
      "Ana Liu is a Colombian guitarist, composer, producer, and arranger known for blending contemporary music with bold originality. A Presidential Scholar at Berklee College of Music, she has recorded and performed with Latin Grammy-winning artists and rising stars including Joaquina, Andrés Cepeda, Teo Bok, Riza, and Diana Burco.",
      "Her original compositions — among them \"Pola,\" \"Don't Wanna Know,\" and \"Mi Piacciono Le Donne Fighe\" — pair technical sophistication with emotional depth. In 2025 she submitted \"Pola\" for Instrumental Composition and the latter two for Dance/Electronic Recording consideration at the 68th GRAMMY Awards.",
      "Ana's arrangements have been praised by artists like Yamandu Costa and featured by Avishai Cohen. Her performances have been broadcast on major radio stations including BIG 105.9 and Y100, and her YouTube channel has reached over 250,000 views globally.",
    ],
    philosophy: undefined,
    social: "@analiunajar",
  },
  {
    slug: "isabella-varela",
    name: "Isabella Varela",
    role: "Voice",
    portraitSrc: "/images/team/bios/isabella-varela.webp",
    bioParagraphs: [
      "Isabella Varela is a Miami-based professional vocalist who performs throughout South Florida and is dedicated to sharing her love for music through teaching. She began singing at 10 years old and has trained extensively with highly acclaimed instructors throughout her musical education.",
      "Although classically trained, Isabella developed a deep passion for jazz during her senior year and has since dedicated herself to exploring the richness of the American songbook and the jazz tradition through both performance and study.",
      "With experience in both classical and jazz styles, Isabella is passionate about helping students of all ages build confidence, strengthen vocal technique, and develop their own artistic voice.",
    ],
    philosophy:
      "Vocal lessons should be personalized to each student's goals and musical interests — a supportive environment where singers can explore and grow through the music they love.",
    social: "@babybluebellaa",
  },
  {
    slug: "enrique-pulley",
    name: "Enrique Pulley",
    role: "Drums, Music Production, Piano, Guitar",
    portraitSrc: "/images/team/bios/enrique-pulley.webp",
    bioParagraphs: [
  ...
  },
  {
    ...
    bioParagraphs: [
      ...
      "Juan is lead guitarist and composer for the DIY indie pop/rock ensemble Stellus, supporting performances across major Florida cities and opening for artists such as Edgehill, Cannibal Kids, Rohna, West 22nd, and Zara Larsson.",
      "Blending philosophies from classical, jazz, and contemporary music education, Juan leads students of all skill levels toward a higher understanding of music theory, fretboard harmony, and musicianship. He draws on his background as a performer, conductor, and educator to help each student find a style suited to their own interpretation and artistry.",
    ],
    philosophy: undefined,
    social: "@jaimesguitar / @officialstellus",
  },
  {
    slug: "kali-fong",
    name: "Kali Fong",
    role: "Voice",
    portraitSrc: "/images/team/bios/kali-fong.webp",
    bioParagraphs: [
      "Kali Fong is a mezzo-soprano originally from St. Petersburg, Florida, now based in Miami. She has performed title roles including Aeneas in Dido and Aeneas, Tolomeo in Giulio Cesare, and Carmen in Carmen, appearing with Santa Fe Opera, Florida Grand Opera, and the Vienna Summer Music Festival.",
      "Alongside her singing, Kali is a stage director and has directed multiple shows with Florida Grand Opera. Beyond opera, she has worked across a variety of pop styles and musical theatre.",
      "Kali studied at Florida International University, earning her bachelor's degree in Classical Voice Performance.",
    ],
    philosophy: undefined,
    social: "@kalifongmezzo",
  },
  {
    ...
    bioParagraphs: [
      ...
      "School orchestras and jazz bands steered him in a new direction, exposing him to Count Basie and Miles Davis while he still loved punk and ska all the while. Professional drummer and former Miami resident Chad Eisinger mentored Mitchell, guiding him through college auditions.",
      "At the University of Miami, Mitchell filled his days and nights with as many playing opportunities as possible, from studio sessions to rehearsals and gigs. Since graduating in fall 2019 he has worked as a teacher, touring drummer, session musician, and music producer.",
      "Based in South Miami, Mitchell has played stages around the US, London, and Mexico.",
    ],
    philosophy: undefined,
    social: "@mattoxworld.wav",
  },
];
